...
def on_entry_click_Text_1(e): # notTypeCast - https://stackoverflow.com/questions/30491721/how-to-insert-a-temporary-text-in-a-tkinter-entry-widget
...
def botao1():
    ...
    def Testes_Variaveis_Saida(variavel_entry_tkinter, variavel_int_tkinter, pos_fila, limite_inferior=0, limite_superior=255,
                               skip=False):
        ...
        if custom_isdigit(variavel_entry_tkinter.get()) == False:
            ...
            forced_text1.place(x=20 + 2 * 120 + 20 + 10 + 15, y=30 * (entry_saida_starting_position + pos_fila) - 5, width=5, height=25)

            forced_text1 = tk.Label(root, text="", fg="red",
                                    font="Helvetica 8 italic")  # Helvetica 12 bold italic
            forced_text1.place(x=20 + 2 * 120 + 20 + 10 + 15, y=30 * (entry_saida_starting_position + pos_fila) + 5, width=70, height=25)
        else:
    ...
    Testes_Variaveis_Saida(entry_widgets[0],output_vars_tkinter[0], pos_fila = 0, limite_inferior=0, limite_superior=255, skip=False)
    Testes_Variaveis_Saida(entry_widgets[1],output_vars_tkinter[1], pos_fila = 1, limite_inferior=0, limite_superior=255, skip=True)
    Testes_Variaveis_Saida(entry_widgets[2],output_vars_tkinter[2], pos_fila = 2, limite_inferior=0, limite_superior=255, skip=True)
    Testes_Variaveis_Saida(entry_widgets[3],output_vars_tkinter[3], pos_fila = 3, limite_inferior=0, limite_superior=255, skip=True)
    Testes_Variaveis_Saida(entry_widgets[4],output_vars_tkinter[4], pos_fila = 4, limite_inferior=0, limite_superior=255, skip=True)
...
button_novo_teste.place(x=0 + 40, y=height - 40, width=120, height=25)
# button_serial_close.config(state='disabled')
...
aguarde_label.place(x=0 + 40 + 120 + 20, y=height - 40, width=120, height=25)
