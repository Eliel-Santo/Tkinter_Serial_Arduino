...
button1 = tk.Button(root,
                   ...
                   fg="black",
                   command=botao1)
button1.place(x=40 + 120, y=15*30, width=120, height=25)
...
frame.place(x=40 + 120 - 40, y=7*30 - 20)
...
radio_0 = tk.Radiobutton(root,
               ...
               value=0)
radio_0.place(x=40 + 120 , y=7*30, width=120, height=25)
...
radio_1 = tk.Radiobutton(root,
               ...
               variable=radio_var_1,
               value=1)
radio_1.place(x=40 + 120, y=8*30, width=120, height=25)
...
radio_2 = tk.Radiobutton(root,
               ...
               variable=radio_var_1,
               value=2)
radio_2.place(x=40 + 120, y=9*30, width=120, height=25)
...
radio_3 = tk.Radiobutton(root,
               ...
               variable=radio_var_1,
               value=3)
radio_3.place(x=40 + 120, y=10*30, width=120, height=25)
