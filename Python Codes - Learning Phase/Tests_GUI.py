...
def update_data():
    ...
    if (ser.inWaiting() > 0):
        ...
        try:
            ...
            Botao1 = list(dict_json.values())[0] # https://www.codingem.com/python-how-to-access-dictionary-values/
            Botao2 = list(dict_json.values())[1] # https://www.codecademy.com/learn/dscp-python-fundamentals/modules/dscp-python-dictionaries/cheatsheet
